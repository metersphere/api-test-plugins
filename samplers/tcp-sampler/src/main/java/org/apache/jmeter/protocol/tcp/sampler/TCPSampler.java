...
public class TCPSampler extends AbstractSampler implements ThreadListener, Interruptible {
    ...
    public SampleResult sample(Entry e)// Entry tends to be ignored ...
    {
        ...
        String sb = String.format("Host: %s Port: %d%n", getServer(), getPort()) +
                String.format("Reuse: %s Close: %s%n", reUseConnection, closeConnection) +
                String.format("[%nSOLINGER: %d EOL: %d noDelay: %s%n]",
                        getSoLinger(), getEolByte(), getNoDelay());
